    ...
    authorize() {
        return request({
            ...
            json: {
                ...
                client_id: ema.apiKeys.anilist.clientID,
                client_secret: ema.apiKeys.anilist.clientSecret
            },
        ...
        return request({
            ...
            if (!this.lastReplyCount || thread.reply_count > this.lastReplyCount) {
                ...
                if (this.lastReplyCount !== undefined)
                    ema.events.emit('new forum reply', `https://anilist.co/forum/thread/${forumThreadId}`, thread.reply_user.display_name);
